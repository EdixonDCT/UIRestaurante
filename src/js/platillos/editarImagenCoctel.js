...
const cargarImagen = async () => {
  ...
  try {
    const res = await fetch(`http://localhost:8080/ApiRestaurente/api/cocteles/${cedula}`);
  ...
  try {
    ...
    try {
            ...
            try {
                    ...
                    const actualizar = await fetch(`http://localhost:8080/ApiRestaurente/api/cocteles/imagen/${cedula}`, {
                        method: "PATCH",
                        headers: {
                    ...
                    await alertaOK("Platillo Coctel: Imagen actualizada con Exito");
                    formulario.submit();
