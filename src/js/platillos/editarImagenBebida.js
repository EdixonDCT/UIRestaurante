...
const cargarImagen = async () => {
  ...
  try {
    const res = await fetch(`http://localhost:8080/ApiRestaurente/api/bebidas/${cedula}`);
  ...
  try {
    ...
    try {
            ...
            try {
                    ...
                    const actualizar = await fetch(`http://localhost:8080/ApiRestaurente/api/bebidas/imagen/${cedula}`, {
                        method: "PATCH",
                        headers: {
                    ...
                    await alertaOK("Platillo Bebida: Imagen actualizada con Exito");
                    formulario.submit();
